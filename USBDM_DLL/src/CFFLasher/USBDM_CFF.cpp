...
CFF_API int bdm_test_for_halt(void) {
   Logging::print("CFF-bdm_test_for_halt()\n");
...
CFF_API int bdm_nop(void) {
   Logging::print("CFF-bdm_nop() - ignored\n");
   return 0;
}
CFF_API int bdm_ta(void) {
   Logging::print("CFF-bdm_ta()\n");
...
CFF_API int bdm_read_word(unsigned long address) {
   ...
   Logging::print("CFF-bdm_read_word()\n");
   return value;
}
...
CFF_API int bdm_load_bin(void) {
   Logging::print("CFF-bdm_load_bin() - not implemented\n");
   return 0;
}
CFF_API int bdm_load_srec(void) {
   Logging::print("CFF-bdm_load_srec() - not implemented\n");
   return 0;
}
