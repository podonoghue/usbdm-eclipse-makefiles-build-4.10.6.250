...
#define USBDM_VERSION_NANO   160     //!< DLL Nano version #

#ifdef LOG
#define USBDM_VERSION_STRING "4.10.6.160-Debug" //!< Version as string
#else
#define USBDM_VERSION_STRING "4.10.6.160"       //!< Version as string
#endif
