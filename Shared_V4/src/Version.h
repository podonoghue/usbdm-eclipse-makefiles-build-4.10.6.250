...
#define USBDM_VERSION_NANO   230     //!< DLL Nano version #

#ifdef LOG
#define USBDM_VERSION_STRING "4.10.6.230-Debug" //!< Version as string
#else
#define USBDM_VERSION_STRING "4.10.6.230"       //!< Version as string
#endif
