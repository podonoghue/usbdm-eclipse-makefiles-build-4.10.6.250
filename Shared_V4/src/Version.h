...
#define USBDM_VERSION_NANO   190     //!< DLL Nano version #

#ifdef LOG
#define USBDM_VERSION_STRING "4.10.6.190-Debug" //!< Version as string
#else
#define USBDM_VERSION_STRING "4.10.6.190"       //!< Version as string
#endif
