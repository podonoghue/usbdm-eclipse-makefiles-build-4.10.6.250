 ...
 *  Vectors.c
 *
 *  Vectors and security for MKL46Z128M4
 *
...
void SLCD_IRQHandler(void)        WEAK_DEFAULT_HANDLER;
void PORTA_IRQHandler(void)       WEAK_DEFAULT_HANDLER;
void PORTC_D_IRQHandler(void)     WEAK_DEFAULT_HANDLER;
...
(intfunc) HardFault_Handler,        /* Vec #3   Hard Fault Handler                           */
          ...
          UART1_IRQHandler,         /* Int #13  UART1 Status and Error interrupt             */
          UART2_IRQHandler,         /* Int #14  UART2 Status and Error interrupt             */
          ...
          TPM2_IRQHandler,          /* Int #19  TPM2 fault, overflow and channels interrupt  */
          ...
          I2S0_IRQHandler,          /* Int #23  I2SO all sources                             */
          USBOTG_IRQHandler,        /* Int #24  USB OTG interrupt                            */
          ...
          SLCD_IRQHandler,          /* Int #29  Reserved                                     */
          PORTA_IRQHandler,         /* Int #30  Port A interrupt                             */
          PORTC_D_IRQHandler        /* Int #31  Port C & D interrupt                         */
    }
};
