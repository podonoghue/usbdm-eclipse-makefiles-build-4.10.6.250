 ...
 * @brief 12-Bit Digital-to-Analog Converter
 */
typedef DAC0_Type DAC1_Type;  /*!< DAC1 Structure                                              */
...
#define DAC1_C0                        (DAC1->C0)
#define DAC1_C1                        (DAC1->C1)
#define DAC1_C2                        (DAC1->C2)
...
#define FMC_S0UM_data(x)                         (((x)<<FMC_S0UM_data_SHIFT)&FMC_S0UM_data_MASK)     /*!< FMC_S0UM                                */
...
#define FMC_S0MU_data(x)                         (((x)<<FMC_S0MU_data_SHIFT)&FMC_S0MU_data_MASK)     /*!< FMC_S0MU                                */
...
#define FMC_S0ML_data(x)                         (((x)<<FMC_S0ML_data_SHIFT)&FMC_S0ML_data_MASK)     /*!< FMC_S0ML                                */
...
#define FMC_DATAW0S0UM                 (FMC->DATAW[0].S0UM)
#define FMC_DATAW0S0MU                 (FMC->DATAW[0].S0MU)
#define FMC_DATAW0S0ML                 (FMC->DATAW[0].S0ML)
#define FMC_DATAW0S0LM                 (FMC->DATAW[0].S0LM)
#define FMC_DATAW0S1UM                 (FMC->DATAW[0].S1UM)
#define FMC_DATAW0S1MU                 (FMC->DATAW[0].S1MU)
#define FMC_DATAW0S1ML                 (FMC->DATAW[0].S1ML)
#define FMC_DATAW0S1LM                 (FMC->DATAW[0].S1LM)
#define FMC_DATAW0S2UM                 (FMC->DATAW[0].S2UM)
#define FMC_DATAW0S2MU                 (FMC->DATAW[0].S2MU)
#define FMC_DATAW0S2ML                 (FMC->DATAW[0].S2ML)
#define FMC_DATAW0S2LM                 (FMC->DATAW[0].S2LM)
#define FMC_DATAW0S3UM                 (FMC->DATAW[0].S3UM)
#define FMC_DATAW0S3MU                 (FMC->DATAW[0].S3MU)
#define FMC_DATAW0S3ML                 (FMC->DATAW[0].S3ML)
#define FMC_DATAW0S3LM                 (FMC->DATAW[0].S3LM)
#define FMC_DATAW1S0UM                 (FMC->DATAW[1].S0UM)
#define FMC_DATAW1S0MU                 (FMC->DATAW[1].S0MU)
#define FMC_DATAW1S0ML                 (FMC->DATAW[1].S0ML)
#define FMC_DATAW1S0LM                 (FMC->DATAW[1].S0LM)
#define FMC_DATAW1S1UM                 (FMC->DATAW[1].S1UM)
#define FMC_DATAW1S1MU                 (FMC->DATAW[1].S1MU)
#define FMC_DATAW1S1ML                 (FMC->DATAW[1].S1ML)
#define FMC_DATAW1S1LM                 (FMC->DATAW[1].S1LM)
#define FMC_DATAW1S2UM                 (FMC->DATAW[1].S2UM)
#define FMC_DATAW1S2MU                 (FMC->DATAW[1].S2MU)
#define FMC_DATAW1S2ML                 (FMC->DATAW[1].S2ML)
#define FMC_DATAW1S2LM                 (FMC->DATAW[1].S2LM)
#define FMC_DATAW1S3UM                 (FMC->DATAW[1].S3UM)
#define FMC_DATAW1S3MU                 (FMC->DATAW[1].S3MU)
#define FMC_DATAW1S3ML                 (FMC->DATAW[1].S3ML)
#define FMC_DATAW1S3LM                 (FMC->DATAW[1].S3LM)
#define FMC_DATAW2S0UM                 (FMC->DATAW[2].S0UM)
#define FMC_DATAW2S0MU                 (FMC->DATAW[2].S0MU)
#define FMC_DATAW2S0ML                 (FMC->DATAW[2].S0ML)
#define FMC_DATAW2S0LM                 (FMC->DATAW[2].S0LM)
#define FMC_DATAW2S1UM                 (FMC->DATAW[2].S1UM)
#define FMC_DATAW2S1MU                 (FMC->DATAW[2].S1MU)
#define FMC_DATAW2S1ML                 (FMC->DATAW[2].S1ML)
#define FMC_DATAW2S1LM                 (FMC->DATAW[2].S1LM)
#define FMC_DATAW2S2UM                 (FMC->DATAW[2].S2UM)
#define FMC_DATAW2S2MU                 (FMC->DATAW[2].S2MU)
#define FMC_DATAW2S2ML                 (FMC->DATAW[2].S2ML)
#define FMC_DATAW2S2LM                 (FMC->DATAW[2].S2LM)
#define FMC_DATAW2S3UM                 (FMC->DATAW[2].S3UM)
#define FMC_DATAW2S3MU                 (FMC->DATAW[2].S3MU)
#define FMC_DATAW2S3ML                 (FMC->DATAW[2].S3ML)
#define FMC_DATAW2S3LM                 (FMC->DATAW[2].S3LM)
#define FMC_DATAW3S0UM                 (FMC->DATAW[3].S0UM)
#define FMC_DATAW3S0MU                 (FMC->DATAW[3].S0MU)
#define FMC_DATAW3S0ML                 (FMC->DATAW[3].S0ML)
#define FMC_DATAW3S0LM                 (FMC->DATAW[3].S0LM)
#define FMC_DATAW3S1UM                 (FMC->DATAW[3].S1UM)
#define FMC_DATAW3S1MU                 (FMC->DATAW[3].S1MU)
#define FMC_DATAW3S1ML                 (FMC->DATAW[3].S1ML)
#define FMC_DATAW3S1LM                 (FMC->DATAW[3].S1LM)
#define FMC_DATAW3S2UM                 (FMC->DATAW[3].S2UM)
#define FMC_DATAW3S2MU                 (FMC->DATAW[3].S2MU)
#define FMC_DATAW3S2ML                 (FMC->DATAW[3].S2ML)
#define FMC_DATAW3S2LM                 (FMC->DATAW[3].S2LM)
#define FMC_DATAW3S3UM                 (FMC->DATAW[3].S3UM)
#define FMC_DATAW3S3MU                 (FMC->DATAW[3].S3MU)
#define FMC_DATAW3S3ML                 (FMC->DATAW[3].S3ML)
#define FMC_DATAW3S3LM                 (FMC->DATAW[3].S3LM)
...
#define FTFA_XACCH_XA(x)                         (((x)<<FTFA_XACCH_XA_SHIFT)&FTFA_XACCH_XA_MASK)     /*!< FTFA_XACCH                              */
...
#define FTFA_XACCL_XA(x)                         (((x)<<FTFA_XACCL_XA_SHIFT)&FTFA_XACCL_XA_MASK)     /*!< FTFA_XACCL                              */
...
#define FTFA_SACCH_XA(x)                         (((x)<<FTFA_SACCH_XA_SHIFT)&FTFA_SACCH_XA_MASK)     /*!< FTFA_SACCH                              */
...
#define FTFA_SACCL_XA(x)                         (((x)<<FTFA_SACCL_XA_SHIFT)&FTFA_SACCL_XA_MASK)     /*!< FTFA_SACCL                              */
...
#define FTFA_XACCH3                    (FTFA->XACCH3)
#define FTFA_XACCH2                    (FTFA->XACCH2)
#define FTFA_XACCH1                    (FTFA->XACCH1)
#define FTFA_XACCH0                    (FTFA->XACCH0)
#define FTFA_XACCL3                    (FTFA->XACCL3)
#define FTFA_XACCL2                    (FTFA->XACCL2)
#define FTFA_XACCL1                    (FTFA->XACCL1)
#define FTFA_XACCL0                    (FTFA->XACCL0)
#define FTFA_SACCH3                    (FTFA->SACCH3)
#define FTFA_SACCH2                    (FTFA->SACCH2)
#define FTFA_SACCH1                    (FTFA->SACCH1)
#define FTFA_SACCH0                    (FTFA->SACCH0)
#define FTFA_SACCL3                    (FTFA->SACCL3)
#define FTFA_SACCL2                    (FTFA->SACCL2)
#define FTFA_SACCL1                    (FTFA->SACCL1)
#define FTFA_SACCL0                    (FTFA->SACCL0)
#define FTFA_FACSS                     (FTFA->FACSS)
#define FTFA_FACSN                     (FTFA->FACSN)
 ...
 * @brief FlexTimer Module (8 channels)
 */
typedef FTM0_Type FTM3_Type;  /*!< FTM3 Structure                                              */


/* -------------------------------------------------------------------------------- */
/* -----------     'FTM3' Register Access macros                        ----------- */
/* -------------------------------------------------------------------------------- */

#define FTM3_SC                        (FTM3->SC)
#define FTM3_CNT                       (FTM3->CNT)
#define FTM3_MOD                       (FTM3->MOD)
#define FTM3_C0SC                      (FTM3->CONTROLS[0].CnSC)
#define FTM3_C0V                       (FTM3->CONTROLS[0].CnV)
#define FTM3_C1SC                      (FTM3->CONTROLS[1].CnSC)
#define FTM3_C1V                       (FTM3->CONTROLS[1].CnV)
#define FTM3_C2SC                      (FTM3->CONTROLS[2].CnSC)
#define FTM3_C2V                       (FTM3->CONTROLS[2].CnV)
#define FTM3_C3SC                      (FTM3->CONTROLS[3].CnSC)
#define FTM3_C3V                       (FTM3->CONTROLS[3].CnV)
#define FTM3_C4SC                      (FTM3->CONTROLS[4].CnSC)
#define FTM3_C4V                       (FTM3->CONTROLS[4].CnV)
#define FTM3_C5SC                      (FTM3->CONTROLS[5].CnSC)
#define FTM3_C5V                       (FTM3->CONTROLS[5].CnV)
#define FTM3_C6SC                      (FTM3->CONTROLS[6].CnSC)
#define FTM3_C6V                       (FTM3->CONTROLS[6].CnV)
#define FTM3_C7SC                      (FTM3->CONTROLS[7].CnSC)
#define FTM3_C7V                       (FTM3->CONTROLS[7].CnV)
#define FTM3_CNTIN                     (FTM3->CNTIN)
#define FTM3_STATUS                    (FTM3->STATUS)
#define FTM3_MODE                      (FTM3->MODE)
#define FTM3_SYNC                      (FTM3->SYNC)
#define FTM3_OUTINIT                   (FTM3->OUTINIT)
#define FTM3_OUTMASK                   (FTM3->OUTMASK)
#define FTM3_COMBINE                   (FTM3->COMBINE)
#define FTM3_DEADTIME                  (FTM3->DEADTIME)
#define FTM3_EXTTRIG                   (FTM3->EXTTRIG)
#define FTM3_POL                       (FTM3->POL)
#define FTM3_FMS                       (FTM3->FMS)
#define FTM3_FILTER                    (FTM3->FILTER)
#define FTM3_FLTCTRL                   (FTM3->FLTCTRL)
#define FTM3_QDCTRL                    (FTM3->QDCTRL)
#define FTM3_CONF                      (FTM3->CONF)
#define FTM3_FLTPOL                    (FTM3->FLTPOL)
#define FTM3_SYNCONF                   (FTM3->SYNCONF)
#define FTM3_INVCTRL                   (FTM3->INVCTRL)
#define FTM3_SWOCTRL                   (FTM3->SWOCTRL)
#define FTM3_PWMLOAD                   (FTM3->PWMLOAD)
...
#define MCG_C7_OSCSEL(x)                         (((x)<<MCG_C7_OSCSEL_SHIFT)&MCG_C7_OSCSEL_MASK)     /*!< MCG_C7                                  */
...
#define SIM_SOPT2_PLLFLLSEL(x)                   (((x)<<SIM_SOPT2_PLLFLLSEL_SHIFT)&SIM_SOPT2_PLLFLLSEL_MASK) /*!< SIM_SOPT2                               */
...
#define SIM_SOPT2_LPUARTSRC(x)                   (((x)<<SIM_SOPT2_LPUARTSRC_SHIFT)&SIM_SOPT2_LPUARTSRC_MASK) /*!< SIM_SOPT2                               */
...
#define SIM_SOPT5_LPUART0RXSRC(x)                (((x)<<SIM_SOPT5_LPUART0RXSRC_SHIFT)&SIM_SOPT5_LPUART0RXSRC_MASK) /*!< SIM_SOPT5                               */
...
#define SIM_SDID_FAMILYID(x)                     (((x)<<SIM_SDID_FAMILYID_SHIFT)&SIM_SDID_FAMILYID_MASK) /*!< SIM_SDID                                */
...
#define DAC0_BASE_PTR                  0x40028000UL
#define DAC1_BASE_PTR                  0x4003F000UL
...
#define FTM3_BASE_PTR                  0x40026000UL
...
#define DAC1                           ((volatile DAC1_Type   *) DAC1_BASE_PTR)
...
#define FTM3                           ((volatile FTM3_Type   *) FTM3_BASE_PTR)
