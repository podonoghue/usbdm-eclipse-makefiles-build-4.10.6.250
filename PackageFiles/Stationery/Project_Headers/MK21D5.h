 ...
 * @file     MK21D5.h
 *
 * @brief    CMSIS Cortex-M Peripheral Access Layer Header File for MK21D5.
 *           Equivalent: MK21DX256M5, MK21DN512M5, MK21DX128M5
 *
 * @version  V0.0
 * @date     2014/01
 *
...
/**
 * @brief Memory Mapped Cryptographic Acceleration Unit (MMCAU)
 */
...
#define FMC_S1_tag_SHIFT                         4                                                   /*!< FMC_S1: tag Position                    */
...
/**
 * @brief Random Number Generator Accelerator (RNG)
 */
...
typedef struct {                                /*!<       RTC Structure                                                */
   ...
   __I  uint32_t  TTSR;                         /*!< 0020: RTC Tamper Time Seconds Register                             */
   __IO uint32_t  MER;                          /*!< 0024: RTC Monotonic Enable Register                                */
   __IO uint32_t  MCLR;                         /*!< 0028: RTC Monotonic Counter Low Register                           */
   __IO uint32_t  MCHR;                         /*!< 002C: RTC Monotonic Counter High Register                          */
...
#define UART1_CFIFO_RXOFE_MASK                   (0x01UL << UART1_CFIFO_RXOFE_SHIFT)                 /*!< UART1_CFIFO: RXOFE Mask                 */
#define UART1_CFIFO_RXOFE_SHIFT                  2                                                   /*!< UART1_CFIFO: RXOFE Position             */
...
#define UART1_SFIFO_RXOF_MASK                    (0x01UL << UART1_SFIFO_RXOF_SHIFT)                  /*!< UART1_SFIFO: RXOF Mask                  */
#define UART1_SFIFO_RXOF_SHIFT                   2                                                   /*!< UART1_SFIFO: RXOF Position              */
