...
/*! \version 1.0 */
/*! \date 2011-04-12 */
/*! \brief Peripheral memory map for mcf51jf128 */
/*! \detailed This header file implements peripheral memory map for mcf51jf128
      processor. */
...
#if !defined(MCU_mcf51jf128)  /* Check if memory map has not been already included */
#define MCU_mcf51jf128

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error mcf51jf128 memory map: There is already included another memory map. Only one memory map can be included.
...
#define RNG_BASE_PTR                             ((RNG_MemMapPtr)0xFFFF98C0u)
...
#define SIM_SCGC5_RNGB_MASK                      0x80u
#define SIM_SCGC5_RNGB_SHIFT                     7
/* SCGC6 Bit Fields */
...
#else /* #if !defined(MCU_mcf51jf128) */
...
#endif  /* #if !defined(MCU_mcf51jf128) */
