 ...
 * @file     MK40D7.h
 *
 * @brief    CMSIS Cortex-M Peripheral Access Layer Header File for MK40D7.
 *           Equivalent: MK40DX64M7, MK40DX256M7, MK40DX128M7
 *
 * @version  V0.0
 * @date     2014/05
 *
...
/**
 * @brief Segment Liquid Crystal Display (LCD)
 */
...
#define LCD_GCR_VSUPPLY(x)                       (((x)<<LCD_GCR_VSUPPLY_SHIFT)&LCD_GCR_VSUPPLY_MASK) /*!< LCD_GCR                                 */
...
#define LCD_BASE_PTR                   0x400BE000UL
