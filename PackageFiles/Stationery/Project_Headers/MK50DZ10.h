 ...
 * @file     MK50DZ10.h
 *
 * @brief    CMSIS Cortex-M Peripheral Access Layer Header File for MK50DZ10.
 *           Equivalent: MK50DX256ZM10, MK50DN512ZM10
 *
 * @version  V0.0
 * @date     2015/01
 *
...
/* ----------------------   MK50DZ10 VectorTable                     ---------------------- */
  ...
  I2S0_IRQn                     =  79,   /*!<  95 Inter-IC Sound / Synchronous Audio Interface                                     */
...
#define PMC_REGSC_VLPRS_MASK                     (0x01UL << PMC_REGSC_VLPRS_SHIFT)                   /*!< PMC_REGSC: VLPRS Mask                   */
#define PMC_REGSC_VLPRS_SHIFT                    3                                                   /*!< PMC_REGSC: VLPRS Position               */
