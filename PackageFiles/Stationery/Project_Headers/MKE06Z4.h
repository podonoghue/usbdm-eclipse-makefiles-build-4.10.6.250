...
typedef struct {                                /*!<       MSCAN Structure                                              */
   ...
   union {                                      /*!< 0000: (size=0004)                                                  */
      __IO uint8_t   REIDR[4];                  /*!< 0020: Receive Extended Identifier Register                        */
      __IO uint8_t   RSIDR[2];                  /*!< 0020: Receive Standard Identifier Register                        */
   };
   __IO uint8_t   REDSR[8];                     /*!< 0024: Receive Extended Data Segment Register                      */
   ...
   union {                                      /*!< 0000: (size=0004)                                                  */
      __IO uint8_t   TEIDR[4];                  /*!< 0030: Transmit Extended Identifier Register                       */
      __IO uint8_t   TSIDR[2];                  /*!< 0030: Transmit Standard Identifier Register                       */
   };
   __IO uint8_t   TEDSR[8];                     /*!< 0034: Transmit Extended Data Segment Register                     */
