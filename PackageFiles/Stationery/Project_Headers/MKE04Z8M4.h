...
/**
 * @brief Flash Memory Interface (FTMRE)
 */
...
#define PORT_IOFLT_FLTIIC(x)                     (((x)<<PORT_IOFLT_FLTIIC_SHIFT)&PORT_IOFLT_FLTIIC_MASK) /*!< PORT_IOFLT                              */
...
#define PORT_IOFLT_FLTFTM0(x)                    (((x)<<PORT_IOFLT_FLTFTM0_SHIFT)&PORT_IOFLT_FLTFTM0_MASK) /*!< PORT_IOFLT                              */
...
#define PORT_IOFLT_FLTPWT(x)                     (((x)<<PORT_IOFLT_FLTPWT_SHIFT)&PORT_IOFLT_FLTPWT_MASK) /*!< PORT_IOFLT                              */
...
#define SIM_SOPT_FTMIC(x)                        (((x)<<SIM_SOPT_FTMIC_SHIFT)&SIM_SOPT_FTMIC_MASK)   /*!< SIM_SOPT                                */
...
#define SIM_SOPT_RXDFE(x)                        (((x)<<SIM_SOPT_RXDFE_SHIFT)&SIM_SOPT_RXDFE_MASK)   /*!< SIM_SOPT                                */
