 ...
 * @file     MK50D7.h
 *
 * @brief    CMSIS Cortex-M Peripheral Access Layer Header File for MK50D7.
 *           Equivalent: MK50DX256M7, MK50DX128M7
 *
 * @version  V0.0
 * @date     2014/05
 *
...
/**
 * @brief General Purpose Operational Amplifier (OPAMP)
 */
typedef struct {                                /*!<       OPAMP0 Structure                                             */
   __IO uint8_t   C0;                           /*!< 0000: Control Register 0                                           */
   __IO uint8_t   C1;                           /*!< 0001: Control Register 1                                           */
   __IO uint8_t   C2;                           /*!< 0002: Control Register 2                                           */
} OPAMP0_Type;


/* -------------------------------------------------------------------------------- */
/* -----------     'OPAMP0' Position & Mask macros                      ----------- */
/* -------------------------------------------------------------------------------- */


/* ------- OPAMP0_C0                                ------ */
#define OPAMP0_C0_MODE_MASK                      (0x03UL << OPAMP0_C0_MODE_SHIFT)                    /*!< OPAMP0_C0: MODE Mask                    */
#define OPAMP0_C0_MODE_SHIFT                     0                                                   /*!< OPAMP0_C0: MODE Position                */
#define OPAMP0_C0_MODE(x)                        (((x)<<OPAMP0_C0_MODE_SHIFT)&OPAMP0_C0_MODE_MASK)   /*!< OPAMP0_C0                               */
#define OPAMP0_C0_LPEN_MASK                      (0x01UL << OPAMP0_C0_LPEN_SHIFT)                    /*!< OPAMP0_C0: LPEN Mask                    */
#define OPAMP0_C0_LPEN_SHIFT                     6                                                   /*!< OPAMP0_C0: LPEN Position                */
#define OPAMP0_C0_EN_MASK                        (0x01UL << OPAMP0_C0_EN_SHIFT)                      /*!< OPAMP0_C0: EN Mask                      */
#define OPAMP0_C0_EN_SHIFT                       7                                                   /*!< OPAMP0_C0: EN Position                  */

/* ------- OPAMP0_C1                                ------ */
#define OPAMP0_C1_AMPRI_MASK                     (0x03UL << OPAMP0_C1_AMPRI_SHIFT)                   /*!< OPAMP0_C1: AMPRI Mask                   */
#define OPAMP0_C1_AMPRI_SHIFT                    0                                                   /*!< OPAMP0_C1: AMPRI Position               */
#define OPAMP0_C1_AMPRI(x)                       (((x)<<OPAMP0_C1_AMPRI_SHIFT)&OPAMP0_C1_AMPRI_MASK) /*!< OPAMP0_C1                               */
#define OPAMP0_C1_AMPRF_MASK                     (0x07UL << OPAMP0_C1_AMPRF_SHIFT)                   /*!< OPAMP0_C1: AMPRF Mask                   */
#define OPAMP0_C1_AMPRF_SHIFT                    2                                                   /*!< OPAMP0_C1: AMPRF Position               */
#define OPAMP0_C1_AMPRF(x)                       (((x)<<OPAMP0_C1_AMPRF_SHIFT)&OPAMP0_C1_AMPRF_MASK) /*!< OPAMP0_C1                               */

/* ------- OPAMP0_C2                                ------ */
#define OPAMP0_C2_AMPNSEL_MASK                   (0x07UL << OPAMP0_C2_AMPNSEL_SHIFT)                 /*!< OPAMP0_C2: AMPNSEL Mask                 */
#define OPAMP0_C2_AMPNSEL_SHIFT                  0                                                   /*!< OPAMP0_C2: AMPNSEL Position             */
#define OPAMP0_C2_AMPNSEL(x)                     (((x)<<OPAMP0_C2_AMPNSEL_SHIFT)&OPAMP0_C2_AMPNSEL_MASK) /*!< OPAMP0_C2                               */
#define OPAMP0_C2_AMPPSEL_MASK                   (0x07UL << OPAMP0_C2_AMPPSEL_SHIFT)                 /*!< OPAMP0_C2: AMPPSEL Mask                 */
#define OPAMP0_C2_AMPPSEL_SHIFT                  4                                                   /*!< OPAMP0_C2: AMPPSEL Position             */
#define OPAMP0_C2_AMPPSEL(x)                     (((x)<<OPAMP0_C2_AMPPSEL_SHIFT)&OPAMP0_C2_AMPPSEL_MASK) /*!< OPAMP0_C2                               */

/* -------------------------------------------------------------------------------- */
/* -----------     'OPAMP0' Register Access macros                      ----------- */
/* -------------------------------------------------------------------------------- */

#define OPAMP0_C0                      (OPAMP0->C0)
#define OPAMP0_C1                      (OPAMP0->C1)
#define OPAMP0_C2                      (OPAMP0->C2)

/* ================================================================================ */
/* ================           OPAMP1 (derived from OPAMP0)         ================ */
/* ================================================================================ */

/**
 * @brief General Purpose Operational Amplifier (OPAMP)
 */
typedef OPAMP0_Type OPAMP1_Type;  /*!< OPAMP1 Structure                                            */


/* -------------------------------------------------------------------------------- */
/* -----------     'OPAMP1' Register Access macros                      ----------- */
/* -------------------------------------------------------------------------------- */

#define OPAMP1_C0                      (OPAMP1->C0)
#define OPAMP1_C1                      (OPAMP1->C1)
#define OPAMP1_C2                      (OPAMP1->C2)
...
#define SIM_SCGC1_OPAMP_MASK                     (0x01UL << SIM_SCGC1_OPAMP_SHIFT)                   /*!< SIM_SCGC1: OPAMP Mask                   */
#define SIM_SCGC1_OPAMP_SHIFT                    21                                                  /*!< SIM_SCGC1: OPAMP Position               */
#define SIM_SCGC1_TRIAMP_MASK                    (0x01UL << SIM_SCGC1_TRIAMP_SHIFT)                  /*!< SIM_SCGC1: TRIAMP Mask                  */
#define SIM_SCGC1_TRIAMP_SHIFT                   24                                                  /*!< SIM_SCGC1: TRIAMP Position              */
...
/* ================================================================================ */
/* ================           TRIAMP0 (file:TRIAMP0_0)             ================ */
/* ================================================================================ */

/**
 * @brief Trans-Impedance Amplifier (TRIAMP0)
 */
typedef struct {                                /*!<       TRIAMP0 Structure                                            */
   __IO uint8_t   C0;                           /*!< 0000: Control Register 0                                           */
} TRIAMP0_Type;


/* -------------------------------------------------------------------------------- */
/* -----------     'TRIAMP0' Position & Mask macros                     ----------- */
/* -------------------------------------------------------------------------------- */


/* ------- TRIAMP0_C0                               ------ */
#define TRIAMP0_C0_LPEN_MASK                     (0x01UL << TRIAMP0_C0_LPEN_SHIFT)                   /*!< TRIAMP0_C0: LPEN Mask                   */
#define TRIAMP0_C0_LPEN_SHIFT                    6                                                   /*!< TRIAMP0_C0: LPEN Position               */
#define TRIAMP0_C0_TRIAMPEN_MASK                 (0x01UL << TRIAMP0_C0_TRIAMPEN_SHIFT)               /*!< TRIAMP0_C0: TRIAMPEN Mask               */
#define TRIAMP0_C0_TRIAMPEN_SHIFT                7                                                   /*!< TRIAMP0_C0: TRIAMPEN Position           */

/* -------------------------------------------------------------------------------- */
/* -----------     'TRIAMP0' Register Access macros                     ----------- */
/* -------------------------------------------------------------------------------- */

#define TRIAMP0_C0                     (TRIAMP0->C0)
...
#define OPAMP0_BASE_PTR                0x400F5000UL
#define OPAMP1_BASE_PTR                0x400F5800UL
...
#define TRIAMP0_BASE_PTR               0x400F8000UL
...
#define OPAMP0                         ((volatile OPAMP0_Type *) OPAMP0_BASE_PTR)
#define OPAMP1                         ((volatile OPAMP1_Type *) OPAMP1_BASE_PTR)
...
#define TRIAMP0                        ((volatile TRIAMP0_Type *) TRIAMP0_BASE_PTR)
