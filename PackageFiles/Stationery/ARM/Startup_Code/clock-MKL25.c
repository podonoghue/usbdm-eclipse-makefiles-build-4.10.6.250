...
void clock_initialise(void) {
   ...
   MCG_C2 =
            MCG_C2_LOCRE0_M      |
            MCG_C2_RANGE0_M      | // low/high/medium clock range
            MCG_C2_HGO0_M        |
            MCG_C2_EREFS0_M      | // select crystal/external clock
            MCG_C2_LP_M          |
   ...
   MCG_C5 =  MCG_C5_PLLCLKEN0_MASK |
             MCG_C5_PRDIV0(MCG_C5_PRDIV0_V);    // PRDIV=?, PLL Ref Freq. = 2-4 MHz
   ...
   MCG_C6 = MCG_C6_PLLS_MASK|MCG_C6_VDIV0_M; // 4MHz x 24 = 96MHz
