...
#define RTC_OSC_VALUE (RTC_OSC_OSC_DISABLE_M|RTC_OSC_SCP_M|RTC_OSC_BOOT_MODE_M)
   ...
   SIM_CLKDIV1 = SIM_CLKDIV1_SYSDIV(5);
...
#define MCG_S_CLKST_M MCG_S_CLKST(MCG_C6_PLLS_V?3:0)
   ...
   SIM_CLKDIV1 = SIM_CLKDIV1_SYSDIV_M | SIM_CLKDIV1_SYSCLKMODE_M;
   ...
   /*!
    * SIM_CTRL_REG Clock multiplexing
    */
#if defined(SIM_CTRL_REG_CLKOUTSEL_MASK)
   SIM_CTRL_REG = (SIM_CTRL_REG&~SIM_CTRL_REG_CLKOUTSEL_MASK)|SIM_CTRL_REG_CLKOUTSEL_M;
#endif

#if defined(SIM_CTRL_REG_SAR_TRG_CLK_SEL_MASK)
   SIM_CTRL_REG = (SIM_CTRL_REG&~SIM_CTRL_REG_SAR_TRG_CLK_SEL_MASK)|SIM_CTRL_REG_SAR_TRG_CLK_SEL_M;
#endif
...
void SystemCoreClockUpdate(void) {
   ...
   SystemCoreClock   = SystemCoreClock/(((SIM_CLKDIV1&SIM_CLKDIV1_SYSDIV_MASK)>>SIM_CLKDIV1_SYSDIV_SHIFT)+1);
   if ((SIM_CLKDIV1&SIM_CLKDIV1_SYSCLKMODE_MASK) != 0) {
