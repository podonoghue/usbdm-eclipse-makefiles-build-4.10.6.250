...
#define MCG_C2_RANGE_M MCG_C2_RANGE(0) // 32-40 kHz
#elif (OSCCLK_CLOCK > 1000000UL) && (OSCCLK_CLOCK <= 8000000UL)
#define MCG_C2_RANGE_M MCG_C2_RANGE(1) // 3-8 MHz
#elif (OSCCLK_CLOCK > 8000000UL) && (OSCCLK_CLOCK <= 32000000UL)
#define MCG_C2_RANGE_M MCG_C2_RANGE(2) // 8-32 MHz
#else
...
//   <i> Controls the crystal oscillator mode of operation [MCG_C2_HGO_V]
//      <0=> Low gain
//      <1=> High gain
...
// MCG_C6_VDIV ==============================
//
//   <o> PLL Multiplication Factor (VDIV) <24-55> <#-24>
//   <i> Determine the multiplication factor of the PLL (x24-x55) [MCG_C6_VDIV]
...
#define SYSTEM_ERCLK32_CLOCK SYSTEM_OSC32KCLK_CLOCK   // 32kHz Oscillator (depends on chip)
...
//   <i> Clocks the ARM Cortex-M4 core (100 MHz max.) [SIM_CLKDIV1_OUTDIV1]
...
// SIM_CLKDIV1_OUTDIV3 ================================
//
//   <o> Flexbus Clock Divider (OUTDIV3) - Divide by <1-16> <#-1>
//   <i> Clocks the flexbus interface (50 MHz max.) [SIM_CLKDIV1_OUTDIV3]
...
#define SYSTEM_FLEXBUS_CLOCK   (SYSTEM_MCGOUTCLK_CLOCK/(SIM_CLKDIV1_OUTDIV3_V+1))
