...
// <validate=net.sourceforge.usbdm.annotationEditor.validators.ClockValidate_MKE06M4>
// FLL clock
// <validate=net.sourceforge.usbdm.annotationEditor.validators.ICSClockValidate_MKE06M4>
