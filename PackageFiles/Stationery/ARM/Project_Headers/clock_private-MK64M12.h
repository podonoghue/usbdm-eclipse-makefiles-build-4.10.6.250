...
// PLL clock
// <validate=net.sourceforge.usbdm.annotationEditor.validators.PllClockValidate_MK64M12>
// FLL clock
...
#endif // (MCG_C1_IREFS_V == 0) || (MCG_C7_OSCSEL_V == 1)
...
// SIM_SOPT2_PLLFLLSEL =============================
//
//   <o> Peripheral clock source (PLL/FLL)
