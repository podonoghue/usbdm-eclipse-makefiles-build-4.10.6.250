...
// <validate=net.sourceforge.usbdm.annotationEditor.validators.ClockValidate_MKE02M4>
// FLL clock
// <validate=net.sourceforge.usbdm.annotationEditor.validators.ICSClockValidate_MKE02M4>
