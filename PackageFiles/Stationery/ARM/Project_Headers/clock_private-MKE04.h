...
// <validate=net.sourceforge.usbdm.annotationEditor.validators.ClockValidate_MKE04M4>
// FLL clock
// <validate=net.sourceforge.usbdm.annotationEditor.validators.ICSClockValidate_MKE04M4>
...
#define SYSTEM_SLOW_IRC_CLOCK (37500UL)
...
#define FLL_TARGET_CLOCK 48000000UL
...
#define SYSTEM_ICSOUT_CLOCK 48000000UL
...
#define SYSTEM_ICSIR_CLOCK 37500UL
...
// SIM_CLKDIV_OUTDIV1 ================================
//
//   <o> Core & System Clock Divider (OUTDIV1) - Divide by <1-4> <#-1> <name=sim_clkdiv_outdiv1>
//   <i> This field sets the divide value for the core/system clock [SIM_CLKDIV_OUTDIV1]
//   <i> ICSOUTCLK. clock is source.
#define SIM_CLKDIV_OUTDIV1_V (0)
#define SIM_CLKDIV_OUTDIV1_M (SIM_CLKDIV_OUTDIV1_V<<SIM_CLKDIV_OUTDIV1_SHIFT)

// SIM_CLKDIV_OUTDIV2 ================================
//
//   <o> Bus & Flash Clock Divider (OUTDIV2) - Divide by <1-2> <#-1> <name=sim_clkdiv_outdiv2>
//   <i> This field sets the divide value for the core/system clock [SIM_CLKDIV_OUTDIV2]
//   <i> ICSOUTCLK/OUTDIV1 clock is source.
#define SIM_CLKDIV_OUTDIV2_V (1)
#define SIM_CLKDIV_OUTDIV2_M (SIM_CLKDIV_OUTDIV2_V<<SIM_CLKDIV_OUTDIV2_SHIFT)

// SIM_CLKDIV_OUTDIV3 ================================
//
//   <o> Timer divider (FTM0,FTM2,PWT) (OUTDIV3) - Divide by <1-2> <#-1> <name=sim_clkdiv_outdiv3>
//   <i> This field sets the divide value for the timers(FTM0, FTM2,PWT) [SIM_CLKDIV_OUTDIV3]
//   <i> ICSOUTCLK clock is source.
#define SIM_CLKDIV_OUTDIV3_V (0)
#define SIM_CLKDIV_OUTDIV3_M (SIM_CLKDIV_OUTDIV3_V<<SIM_CLKDIV_OUTDIV3_SHIFT)
// </h>
...
#define ICS_C1_CLKS_M ICS_C1_CLKS(ICS_C1_CLKS_V)
...
#define ICS_C2_BDIV_M ICS_C2_BDIV(ICS_C2_BDIV_V)
...
#define RTC_SC_RTCLKS_M RTC_SC_RTCLKS(RTC_SC_RTCLKS_V)
