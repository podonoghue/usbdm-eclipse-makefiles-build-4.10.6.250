...
#ifdef LED_GREEN_PORT
   SIM_SCGC5 |=  PORT_CLOCK_MASK(LED_GREEN_PORT);
   greenLedOff();
...
#ifdef LED_RED_PORT
   SIM_SCGC5 |=  PORT_CLOCK_MASK(LED_RED_PORT);
   redLedOff();
...
#ifdef LED_BLUE_PORT
   SIM_SCGC5 |=  PORT_CLOCK_MASK(LED_BLUE_PORT);
   blueLedOff();
   PDDR(LED_BLUE_PORT)              |= (1<<LED_BLUE_NUM);
...
#ifdef LED_ORANGE_PORT
   SIM_SCGC5 |=  PORT_CLOCK_MASK(LED_ORANGE_PORT);
   orangeLedOff();
