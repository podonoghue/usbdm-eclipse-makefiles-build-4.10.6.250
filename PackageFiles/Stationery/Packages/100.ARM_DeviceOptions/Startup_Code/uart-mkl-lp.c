...
inline static void initDefaultUart()  {
   ...
   SIM_SCGC5 |= SIM_SCGC5_PORTB_MASK|SIM_SCGC5_LPUART0_MASK;

   // Select Tx & Rx pins to use
   SIM_SOPT5 &= ~(SIM_SOPT5_LPUART0ODE_MASK|SIM_SOPT5_LPUART0RXSRC_MASK|SIM_SOPT5_LPUART0TXSRC_MASK);
...
inline static void initDefaultUart()  {
   ...
   // Enable clock to LPUART
   // Enable clock to port pins used by LPUART
   SIM_SCGC5 |= SIM_SCGC5_PORTA_MASK|SIM_SCGC5_LPUART0_MASK;
...
inline static void initDefaultUart()  {
   ...
   SIM_SOPT2 = (SIM_SOPT2 & ~SIM_SOPT2_LPUART0SRC_MASK) | SIM_SOPT2_LPUART0SRC(1);
