...
#ifndef SIM_OSC1_CNTRL
#define SIM_OSC1_CNTRL SIM_OSC1
#endif
...
void clock_initialise(void) {
   ...
   SIM_OSC1_CNTRL = SIM_OSC1_OSC1EN_M|SIM_OSC1_OSC1RANGE_M|SIM_OSC1_OSC1HGO_M|SIM_OSC1_OSC1EREFS_M;
...
void SystemCoreClockUpdate(void) {
   ...
   SystemCoreClock   = SystemCoreClock/(((SIM_CLKDIV0&SIM_CLKDIV0_OUTDIV_MASK)>>SIM_CLKDIV0_OUTDIV_SHIFT)+1);
