...
%CANDLE% %CANDLE_OPTIONS% -dProductVersion=%VERSIONn% -dTargetArchCondition="NOT Msix64" -o %WIX_BUILD_DIR%\%MSI_FILE_X32%.wixobj *.wxs
...
%CANDLE% %CANDLE_OPTIONS% -dProductVersion=%VERSIONn% -dTargetArchCondition="Msix64"     -o %WIX_BUILD_DIR%\%MSI_FILE_X64%.wixobj *.wxs
%LIGHT% %LIGHT_OPTIONS% %LIGHT_DIRS% -out %MSI_FILE_X32% %WIX_BUILD_DIR%\*x32.wixobj %WIX_DIR%\difxapp_x86.wixlib
%LIGHT% %LIGHT_OPTIONS% %LIGHT_DIRS% -out %MSI_FILE_X64% %WIX_BUILD_DIR%\*x64.wixobj %WIX_DIR%\difxapp_x64.wixlib
