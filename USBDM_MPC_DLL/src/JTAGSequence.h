...
#define JTAG_SHIFT_OUT_D(x)      (60),(x)                  // #8=N    Shift out N bits, data taken from dataPtr
#define JTAG_SHIFT_IN_D(x)       (61),(x)                  // #8=N    Shift in N bits
#define JTAG_SHIFT_IN_OUT_D(x)   (62),(x)                  // #8=N    Shift out & in N bits, data taken from dataPtr
