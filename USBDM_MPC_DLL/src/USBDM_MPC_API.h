/*! \file
    \brief Header file for USBDM_MPC_API.c
   ...
   +====================================================================
    \endverbatim
 */
#ifndef USBDM_MPC_API_H_
#define USBDM_MPC_API_H_
...
#ifdef USBDMMPC_DLL_EXPORTS
   //! These definitions are used when USBDM_MPC_API is being exported (creating DLL)
   #define USBDM_MPC_API      EXTERN_C DLL_EXPORT
#else
   //! These definitions are used when USBDM_MPC_API is being imported (linking against DLL)
   #define USBDM_MPC_API      EXTERN_C DLL_IMPORT
#endif
//==================================================
