...
const wxString choices[] = {_("HCS12"), _("HCS08"), _("RS08"), _("CFV1"), _("CFV 2, 3 or 4"), _("JTAG"), _("EZFLASH"), _("MC56F80xx"), };

   wxSingleChoiceDialog dialogue(NULL, wxEmptyString, _("Choose Target"), sizeof(choices)/sizeof(choices[0]), choices);
   dialogue.ShowModal();
