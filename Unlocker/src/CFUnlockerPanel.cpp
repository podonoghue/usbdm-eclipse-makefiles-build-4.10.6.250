...
/*
 * ColdfireUnlockerPanel type definition
 */
IMPLEMENT_CLASS( ColdfireUnlockerPanel, wxPanel)
/*
...
ColdfireUnlockerPanel::ColdfireUnlockerPanel(wxWindow* parent, Shared *shared) :
   ...
   Create(parent, SYMBOL_COLDFIREUNLOCKERPANEL_IDNAME, wxDefaultPosition,
         wxSize(500, 300),
         SYMBOL_COLDFIREUNLOCKERPANEL_STYLE);
}

/*
 * ColdfireUnlockerDialogue creator
 */
bool ColdfireUnlockerPanel::Create(wxWindow* parent, wxWindowID id,
      const wxPoint& pos, const wxSize& size, long style) {
   Logging Log("ColdfireUnlockerPanel::Create");
...
void ColdfireUnlockerPanel::Init() {
   Logging Log("ColdfireUnlockerPanel::Init");
...
void ColdfireUnlockerPanel::CreateControls() {
   Logging Log("ColdfireUnlockerPanel::CreateControls");
   ...
   wxStaticBox* itemStaticBoxSizer3Static = new wxStaticBox(dialogue, wxID_ANY,
         _("1. JTAG Chain"));
   wxStaticBoxSizer* itemStaticBoxSizer3 = new wxStaticBoxSizer(
         itemStaticBoxSizer3Static, wxHORIZONTAL);
   dialogueSizerV->Add(itemStaticBoxSizer3, 0, wxGROW | wxALL, 5);

   initChainButtonControl = new wxButton(dialogue, ID_INIT_CHAIN_BUTTON,
         _("Initialise JTAG chain"), wxDefaultPosition, wxDefaultSize, 0);
   itemStaticBoxSizer3->Add(initChainButtonControl, 0,
         wxALIGN_CENTER_VERTICAL | wxALL, 5);

   numberOfDeviceStaticControl = new wxStaticText(dialogue,
         wxID_NUMBER_OF_DEVICES_STATIC, _("Number of devices found: -"),
         wxDefaultPosition, wxDefaultSize, 0);
   itemStaticBoxSizer3->Add(numberOfDeviceStaticControl, 0,
         wxALIGN_CENTER_VERTICAL | wxALL, 5);

   //====================================================================

   wxStaticBox* itemStaticBoxSizer6Static = new wxStaticBox(dialogue, wxID_ANY,
         _("2. Select device in chain to erase"));
   wxStaticBoxSizer* itemStaticBoxSizer6 = new wxStaticBoxSizer(
         itemStaticBoxSizer6Static, wxVERTICAL);
   ...
   wxStaticText* itemStaticText8 = new wxStaticText(dialogue, wxID_STATIC,
         _("JTAG Device #"), wxDefaultPosition, wxDefaultSize, 0);
   gridBagSizer->Add(itemStaticText8, wxGBPosition(0, 1), wxGBSpan(1, 1),
         wxALIGN_CENTER_VERTICAL);

   wxStaticText* itemStaticText9 = new wxStaticText(dialogue, wxID_STATIC,
         _("IR\nLength"), wxDefaultPosition, wxDefaultSize, 0);
   gridBagSizer->Add(itemStaticText9, wxGBPosition(0, 2), wxGBSpan(1, 1),
         wxALIGN_CENTER_VERTICAL);

   jtagIdcodeStaticText = new wxStaticText(dialogue, wxID_JTAG_IDCODE_STATIC,
         _("IDCODE: - 00000000 "), wxDefaultPosition, wxDefaultSize, 0);
   gridBagSizer->Add(jtagIdcodeStaticText, wxGBPosition(0, 3), wxGBSpan(1, 1),
         wxALIGN_CENTER_VERTICAL);
   ...
   jtagDeviceChoiceControl = new wxChoice(dialogue, ID_JTAG_DEVICE_CHOICE,
         wxDefaultPosition, wxDefaultSize, jtagDeviceChoiceControlStrings, 0);
   jtagDeviceChoiceControl->Enable(false);
   gridBagSizer->Add(jtagDeviceChoiceControl, wxGBPosition(1, 1),
         wxGBSpan(1, 1), wxALIGN_CENTER_VERTICAL);

   irLengthSpinControl = new wxSpinCtrl(dialogue, ID_IR_LENGTH_SPINCTRL,
         _T("0"), wxDefaultPosition, wxSize(40, -1), wxSP_ARROW_KEYS, 0, 100,
         0);
   gridBagSizer->Add(irLengthSpinControl, wxGBPosition(1, 2), wxGBSpan(1, 1),
         wxALIGN_CENTER_VERTICAL);

   freescalePINStaticControl = new wxStaticText(dialogue, wxID_PIN_STATIC,
         _("Freescale PIN: -"), wxDefaultPosition, wxDefaultSize, 0);
   gridBagSizer->Add(freescalePINStaticControl, wxGBPosition(1, 3),
         wxGBSpan(1, 1), wxALIGN_CENTER_VERTICAL);

   totalIrLengthStaticControl = new wxStaticText(dialogue, wxID_STATIC,
         _("Total IR Length: -"), wxDefaultPosition, wxDefaultSize, 0);
   gridBagSizer->Add(totalIrLengthStaticControl, wxGBPosition(2, 1),
         wxGBSpan(1, 1), wxALIGN_CENTER_VERTICAL);

   descriptionStaticControl = new wxStaticText(dialogue, wxID_STATIC,
         _("Desc: -"), wxDefaultPosition, wxDefaultSize, 0);
   gridBagSizer->Add(descriptionStaticControl, wxGBPosition(2, 2),
         wxGBSpan(1, 2), wxALIGN_CENTER_VERTICAL);

   //====================================================================

   wxStaticBox* itemStaticBoxSizer18Static = new wxStaticBox(dialogue, wxID_ANY,
         _("3. Select target device type and speed"));
   wxStaticBoxSizer* itemStaticBoxSizer18 = new wxStaticBoxSizer(
         itemStaticBoxSizer18Static, wxHORIZONTAL);
   dialogueSizerV->Add(itemStaticBoxSizer18, 0, wxGROW | wxALL, 5);

   wxArrayString targetDeviceChoiceControlStrings;
   targetDeviceChoiceControl = new wxChoice(dialogue, ID_TARGET_DEVICE_CHOICE,
         wxDefaultPosition, wxDefaultSize, targetDeviceChoiceControlStrings, 0);
   itemStaticBoxSizer18->Add(targetDeviceChoiceControl, 0,
         wxALIGN_CENTER_VERTICAL | wxALL, 5);

   targetSpeedTextControl = new NumberTextEditCtrl(dialogue, ID_SPEED_TEXTCTRL,
         wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
   itemStaticBoxSizer18->Add(targetSpeedTextControl, 0,
         wxALIGN_CENTER_VERTICAL | wxALL, 5);

   wxStaticText* itemStaticText21 = new wxStaticText(dialogue, wxID_STATIC,
         _("kHz"), wxDefaultPosition, wxDefaultSize, 0);
   itemStaticBoxSizer18->Add(itemStaticText21, 0,
         wxALIGN_CENTER_VERTICAL | wxALL, 5);

   //====================================================================

   wxStaticBox* itemStaticBoxSizer22Static = new wxStaticBox(dialogue, wxID_ANY,
         _("4. Select Flash clock limits and equation"));
   wxStaticBoxSizer* itemStaticBoxSizer22 = new wxStaticBoxSizer(
         itemStaticBoxSizer22Static, wxVERTICAL);
   ...
   wxStaticText* itemStaticText25 = new wxStaticText(dialogue, wxID_STATIC,
         _("Minimum Frequency"), wxDefaultPosition, wxDefaultSize, 0);
   itemBoxSizer24->Add(itemStaticText25, 0, wxALIGN_CENTER_HORIZONTAL | wxALL,
         5);

   minimumFrequencyTextControl = new NumberTextEditCtrl(dialogue,
         ID_MIN_FREQ_TEXTCTRL, wxEmptyString, wxDefaultPosition, wxDefaultSize,
         0);
   itemBoxSizer24->Add(minimumFrequencyTextControl, 0,
         wxALIGN_CENTER_HORIZONTAL | wxALL, 5);

   wxBoxSizer* itemBoxSizer27 = new wxBoxSizer(wxVERTICAL);
   itemBoxSizer23->Add(itemBoxSizer27, 1, wxGROW | wxALL, 5);

   wxStaticText* itemStaticText28 = new wxStaticText(dialogue, wxID_STATIC,
         _("Maximum Frequency"), wxDefaultPosition, wxDefaultSize, 0);
   itemBoxSizer27->Add(itemStaticText28, 0, wxALIGN_CENTER_HORIZONTAL | wxALL,
         5);

   maximumFrequencyTextControl = new NumberTextEditCtrl(dialogue,
         ID_MAX_FREQ_TEXTCTRL, wxEmptyString, wxDefaultPosition, wxDefaultSize,
         0);
   itemBoxSizer27->Add(maximumFrequencyTextControl, 0,
         wxALIGN_CENTER_HORIZONTAL | wxALL, 5);

   wxArrayString equationChoiceControlStrings;
   equationChoiceControl = new wxChoice(dialogue, ID_EQUATION_CHOICE,
         wxDefaultPosition, wxDefaultSize, equationChoiceControlStrings, 0);
   itemStaticBoxSizer22->Add(equationChoiceControl, 0, wxGROW | wxALL, 5);

   //====================================================================

   wxStaticBox* itemStaticBoxSizer31Static = new wxStaticBox(dialogue, wxID_ANY,
         _("5. Select Erase parameters"));
   wxStaticBoxSizer* itemStaticBoxSizer31 = new wxStaticBoxSizer(
         itemStaticBoxSizer31Static, wxHORIZONTAL);
   dialogueSizerV->Add(itemStaticBoxSizer31, 0, wxGROW | wxALL, 5);

   wxBoxSizer* itemBoxSizer32 = new wxBoxSizer(wxVERTICAL);
   itemStaticBoxSizer31->Add(itemBoxSizer32, 0, wxALIGN_CENTER_VERTICAL | wxALL,
         5);

   wxStaticText* itemStaticText33 = new wxStaticText(dialogue, wxID_STATIC,
         _("Unlock Instruction (hex)"), wxDefaultPosition, wxDefaultSize,
         0);
   itemBoxSizer32->Add(itemStaticText33, 0, wxALIGN_CENTER_HORIZONTAL | wxALL,
         5);

   unlockInstructionTextControl = new NumberTextEditCtrl(dialogue,
         ID_UNLOCK_VALUE_TEXTCTRL, wxEmptyString, wxDefaultPosition,
         wxDefaultSize, 0);
   itemBoxSizer32->Add(unlockInstructionTextControl, 0,
         wxALIGN_CENTER_HORIZONTAL | wxALL, 5);

   wxBoxSizer* itemBoxSizer35 = new wxBoxSizer(wxVERTICAL);
   itemStaticBoxSizer31->Add(itemBoxSizer35, 0, wxALIGN_CENTER_VERTICAL | wxALL,
         5);

   wxStaticText* itemStaticText36 = new wxStaticText(dialogue, wxID_STATIC,
         _("Clk Divider value (hex)"), wxDefaultPosition, wxDefaultSize, 0);
   itemBoxSizer35->Add(itemStaticText36, 0, wxALIGN_CENTER_HORIZONTAL | wxALL,
         5);

   clockDividerTextControl = new NumberTextEditCtrl(dialogue,
         ID_CLOCK_DIVIDER_VALUE_TEXTCTRL, wxEmptyString, wxDefaultPosition,
         wxDefaultSize, 0);
   itemBoxSizer35->Add(clockDividerTextControl, 0,
         wxALIGN_CENTER_HORIZONTAL | wxALL, 5);

   versionStaticControl = new wxStaticText(dialogue, wxID_VERSION_STATIC,
         _("CF Unlocker V4"), wxDefaultPosition, wxDefaultSize, 0);
   ...
   wxButton* itemButton40 = new wxButton(dialogue, wxID_CANCEL, _("Cancel"),
         wxDefaultPosition, wxDefaultSize, 0);
   ...
   unlockButtonControl = new wxButton(dialogue, ID_UNLOCK_BUTTON,
         _("6. Unlock and Erase"), wxDefaultPosition, wxDefaultSize, 0);
   itemBoxSizer39->Add(unlockButtonControl, 0, wxALIGN_CENTER_VERTICAL | wxALL,
         5);

   targetSpeedTextControl->SetDecimalValue(1000);
}

//===================================================================
//! Update the dialogue from internal state
//!
bool ColdfireUnlockerPanel::TransferDataToWindow() {
   Logging Log("ColdfireUnlockerPanel::TransferDataToWindow");

   return true;
}

//===================================================================
//! Update the internal state from dialogue
//!
bool ColdfireUnlockerPanel::TransferDataFromWindow() {
   Logging Log("ColdfireUnlockerPanel::TransferDataFromWindow");
   return true;
}

bool ColdfireUnlockerPanel::updateState() {
   Logging Log("ColdfireUnlockerPanel::updateState");
...
void ColdfireUnlockerPanel::OnInitChainButtonClick(wxCommandEvent& event) {
   ...
   if (USBDM_SetTargetTypeWithRetry(T_JTAG) != BDM_RC_OK) {
      return;
   }
   loadJTAGDeviceList();
 ...
 */
void ColdfireUnlockerPanel::OnTargetDeviceChoiceSelected(
 ...
 */
void ColdfireUnlockerPanel::OnMinFreqTextctrlTextUpdated(
      wxCommandEvent& event) {
   updateClockDividerValue();
}
 ...
 */
void ColdfireUnlockerPanel::OnMaxFreqTextctrlTextUpdated(
      wxCommandEvent& event) {
   updateClockDividerValue();
}
 ...
 */
void ColdfireUnlockerPanel::OnUnlockValueTextctrlTextUpdated(
      wxCommandEvent& event) {
   event.Skip();
}
 ...
 */
void ColdfireUnlockerPanel::OnClockDividerValueTextctrlTextUpdated(
      wxCommandEvent& event) {
   event.Skip();
}
...
void ColdfireUnlockerPanel::loadDeviceList() {
   Logging Log("ColdfireUnlockerPanel::loadDeviceList");
   unsigned int deviceCount;

   for (deviceCount = 0; deviceCount < KnownDevices::deviceCount;
         deviceCount++) {
      targetDeviceChoiceControl->Append(
            wxString::FromAscii(KnownDevices::deviceData[deviceCount].name));
   }
...
void ColdfireUnlockerPanel::loadEraseMethodsList() {
   Logging Log("ColdfireUnlockerPanel::loadEraseMethodsList");
   unsigned int methodNum;

   for (methodNum = 0; methodNum < FlashEraseMethods::getNumMethods();
         methodNum++) {
      equationChoiceControl->Append(
            wxString::FromAscii(
                  FlashEraseMethods::getMethod(methodNum)->getDescription()));
   }
...
void ColdfireUnlockerPanel::updateClockDividerValue() {
   ...
   clkDividerValue =
         FlashEraseMethods::getCurrentMethod()->findFlashDividerValue(clockFreq,
               fMin, fMax);
...
void ColdfireUnlockerPanel::updateEraseParameters() {
   ...
   if (KnownDevices::deviceData[index].irLengthKnown) { // IR Length is known & fixed
      irLengthSpinControl->SetValue(
            KnownDevices::deviceData[index].instructionLength);
...
//      irLengthSpinControl->SetValue(JTAG_Chain::getTargetDevice().irLength);
   ...
   // Update Fmin
   minimumFrequencyTextControl->SetDecimalValue(
         KnownDevices::deviceData[index].fMin / 1000);

   // Update Fmax
   maximumFrequencyTextControl->SetDecimalValue(
         KnownDevices::deviceData[index].fMax / 1000);

   // Update Unlock instruction value
   unlockInstructionTextControl->SetHexValue(
         KnownDevices::deviceData[index].unlockInstruction);

   // Update erase methods
   FlashEraseMethods::setMethodIndex(
         KnownDevices::deviceData[index].flashEquation);
   equationChoiceControl->SetSelection(
         FlashEraseMethods::getCurrentMethodIndex());
...
void ColdfireUnlockerPanel::updateDeviceDetails() {
   ...
   sprintf(buff, "Desc : %s",
         JTAG_Chain::getTargetDevice().deviceData->description);
   //Logging::print("%s\n",buff);
   descriptionStaticControl->SetLabel(wxString::FromAscii(buff));

   targetDeviceChoiceControl->SetSelection(
         JTAG_Chain::getTargetDevice().deviceData->index);
   targetDeviceChoiceControl->Enable(
         JTAG_Chain::getTargetDevice().deviceData
               == &KnownDevices::unRecognizedDevice);
...
void ColdfireUnlockerPanel::loadJTAGDeviceList() {
   Logging Log("ColdfireUnlockerPanel::loadJTAGDeviceList");
   unsigned int device;
   char buff[100];
...
//! the desired device and the known size of the IR for that device.
//!
...
void ColdfireUnlockerPanel::findDeviceInJTAGChain(unsigned int deviceNum) {
   Logging Log("ColdfireUnlockerPanel::findDeviceInJTAGChain");
   unsigned int index;
   unsigned int oIndex;
   unsigned int iIndex;
   ...
   if (deviceNum == 0) { // 1st in chain
      ...
      usefulIrCount = 0;
      for (oIndex = deviceNum;
            oIndex <= irCount - (JTAG_Chain::deviceCount - deviceNum);
            oIndex++) {
         for (iIndex = oIndex + 1;
               iIndex <= irCount - (JTAG_Chain::deviceCount - deviceNum) + 1;
               iIndex++) {
...
USBDM_ErrorCode ColdfireUnlockerPanel::eraseDscDevice() {
   Logging Log("ColdfireUnlockerPanel::eraseDscDevice");
   ...
   Logging::print(
         "Erasing JTAG device #%d, Unlock command=%2.2X, Clock Divider=%2.2X\n",
   ...
   do {
      ...
      rc = USBDM_SetTargetTypeWithRetry(T_JTAG);
      if (rc != BDM_RC_OK) {
         return rc;
      }
...
USBDM_ErrorCode ColdfireUnlockerPanel::eraseCFVxDevice() {
   Logging Log("ColdfireUnlockerPanel::eraseCFVxDevice");
   unsigned int deviceNumber = 0;
   uint8_t unlockCommand[1];
   uint8_t clockDividerValue[1];
